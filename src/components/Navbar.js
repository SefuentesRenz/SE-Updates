      ...
      <div className="navbar-center">
        ...
        <div className="navbar-links">
          ...
          <div className="dropdown">
            ...
            {dropdown === "account" && (
              <div className="dropdown-menu">
                <Link to="/MyAccount" className="dropdown-item">View Profile</Link>
          ...
          <div className="dropdown">
            ...
            {dropdown === "reports" && (
              <div className="dropdown-menu">
                <Link to="/NewsEvents" className="dropdown-item">News & Events</Link>
                <Link to="/AlumniSurvey" className="dropdown-item">Alumni Survey</Link>
          ...
          <div className="dropdown">
            ...
            {dropdown === "jobs" && (
              <div className="dropdown-menu">
                <Link to="/JobPost" className="dropdown-item">Post a Job</Link>
                <Link to="/lookforajob" className="dropdown-item">Look for a Job</Link>
              </div>
            )}
          </div>
        </div>
